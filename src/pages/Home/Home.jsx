      ...
      <div className="hero">
        ...
        <div className="hero-caption">
          ...
          <p>Discovering his ties to a secret ancient order, a young man living in modern
             Istanbul embarks on a quest to save the city from living in modern Istanbul embarks on 
            a quest to save the city from an immortal enemy.</p>
            <div className="hero-btns">
              <button className='btn'><img src={play_icon} alt="play-btn" />
              Play</button>
              <button className='btn dark-btn'><img src={info_icon} alt="info-btn" />
              More Info</button>
            </div>
